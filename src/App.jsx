        ...
        <div className="descarga__contenedor">
          ...
          <div className="descarga__grid">
            <div className="descarga__imagen">
              <img src="https://github.com/cristiandjr/listado_de_tareas_react/blob/main/src/assets/celu.png" alt="img del celular mostrando la lista de tareas" />
            </div>
            <div className="listado">
        ...
        <div className="footer__contenedor">
          <div className="footer__grid">
            <div className="footer__logo">
              <img src="https://github.com/cristiandjr/listado_de_tareas_react/blob/main/src/assets/footer_logo.png" alt="img del logo footer" />
            </div>
